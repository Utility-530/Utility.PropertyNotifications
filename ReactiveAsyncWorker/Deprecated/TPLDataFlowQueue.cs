...
//            tasks?
//                .Select(kvp => new WorkerItem<T>(kvp.Value, kvp.Key))
//                .Subscribe(async workerItem =>
//                {
//                    await Enqueue(workerItem);
...
//            return await _block.SendAsync(() =>/* _dispatcher.InvokeAsync*/_.Start());
//        }
