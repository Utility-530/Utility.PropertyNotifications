...
namespace Utility.Tasks
{
    public static class BackgroundWorkerHelper
    {
        ...
        public static IObservable<RunWorkerCompletedEventArgs<T>> GetCompletion<T>(this BackgroundWorker<IWorkerArgument<T>, T, T> backgroundWorker)
        {
            return
           System.Reactive.Linq.Observable
                 .FromEventPattern<RunWorkerCompletedEventArgs<T>>(h => backgroundWorker.RunWorkerCompleted += h, h => backgroundWorker.RunWorkerCompleted -= h)
        ...
        public static IObservable<ProgressChangedEventArgs<T>> GetProgress<T>(this BackgroundWorker<IWorkerArgument<T>, T, T> backgroundWorker)
    => Observable
...
=> Observable
     ...
     h => backgroundWorker.ProgressChanged += h, h => backgroundWorker.ProgressChanged -= h)
        ...
        public static IObservable<long> GetTime<T>(this BackgroundWorker<IWorkerArgument<T>, T, T> backgroundWorker, long timeout, IObservable<T> Result)
            => Observable.FromEventPattern<DoWorkEventArgs<IWorkerArgument<T>, T>>(
