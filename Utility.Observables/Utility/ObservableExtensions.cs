...
namespace Utility.Observables
{
    ...
    public static class ObservableExtensions
    {
        ...
        public static IDisposable Subscribe(this IObservable source)
        {
            ...
            //
            return source.Subscribe/*Unsafe*/(new Observer(Stubs.Ignore, Stubs.Throw, Stubs.Nop));
        }
        ...
        public static IDisposable Subscribe(this IObservable source, Action<object> onNext)
        {
            ...
            // [OK] Use of unsafe Subscribe: non-pretentious constructor for an observer; this overload is not to be used internally.
            //
            return source.Subscribe/*Unsafe*/(new Observer(onNext, Stubs.Throw, Stubs.Nop));
        }
        ...
        public static IDisposable Subscribe(this IObservable source, Action<object> onNext, Action<Exception> onError)
        {
            ...
            // [OK] Use of unsafe Subscribe: non-pretentious constructor for an observer; this overload is not to be used internally.
            //
            return source.Subscribe/*Unsafe*/(new Observer(onNext, onError, Stubs.Nop));
        }
        ...
        public static IDisposable Subscribe(this IObservable source, Action<object> onNext, Action onCompleted)
        {
            ...
            // [OK] Use of unsafe Subscribe: non-pretentious constructor for an observer; this overload is not to be used internally.
            //
            return source.Subscribe/*Unsafe*/(new Observer(onNext, Stubs.Throw, onCompleted));
        }
        ...
        public static IDisposable Subscribe(this IObservable source, Action<object> onNext, Action<Exception> onError, Action onCompleted)
        {
            ...
            // [OK] Use of unsafe Subscribe: non-pretentious constructor for an observer; this overload is not to be used internally.
            //
            return source.Subscribe/*Unsafe*/(new Observer(onNext, onError, onCompleted));
        }
        ...
        //    source.Subscribe_(new Observer(Stubs.Ignore, Stubs.Throw, Stubs.Nop), token);
        //}
        ...
        ///// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        ///// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> is <c>null</c>.</exception>
        //public static void Subscribe(this IObservable source, Action<object> onNext, CancellationToken token)
        //{
        //    if (source == null)
        //    {
        //        throw new ArgumentNullException(nameof(source));
        ...
        //    source.Subscribe_(new Observer(onNext, Stubs.Throw, Stubs.Nop), token);
        //}
        ...
        ///// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        ///// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> or <paramref name="onError"/> is <c>null</c>.</exception>
        //public static void Subscribe(this IObservable source, Action<object> onNext, Action<Exception> onError, CancellationToken token)
        //{
        //    if (source == null)
        //    {
        //        throw new ArgumentNullException(nameof(source));
        ...
        //    source.Subscribe_(new Observer(onNext, onError, Stubs.Nop), token);
        //}
        ...
        ///// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        ///// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> or <paramref name="onCompleted"/> is <c>null</c>.</exception>
        //public static void Subscribe(this IObservable source, Action<object> onNext, Action onCompleted, CancellationToken token)
        //{
        //    if (source == null)
        //    {
        //        throw new ArgumentNullException(nameof(source));
        ...
        //    source.Subscribe_(new Observer(onNext, Stubs.Throw, onCompleted), token);
        //}
        ...
        /////// <param name="token">CancellationToken that can be signaled to unsubscribe from the source sequence.</param>
        /////// <exception cref="ArgumentNullException"><paramref name="source"/> or <paramref name="onNext"/> or <paramref name="onError"/> or <paramref name="onCompleted"/> is <c>null</c>.</exception>
        ////public static void Subscribe(this IObservable source, Action<object> onNext, Action<Exception> onError, Action onCompleted, CancellationToken token)
        ////{
        ////    if (source == null)
        ////    {
        ////        throw new ArgumentNullException(nameof(source));
        ...
        ////    source.Subscribe_(new Observer(onNext, onError, onCompleted), token);
        ////}
        ...
        ////        {
        ////            var consumer = Observer.Wrap(observer);
        ...
        //        if (source is IProducer producer)
        //        {
