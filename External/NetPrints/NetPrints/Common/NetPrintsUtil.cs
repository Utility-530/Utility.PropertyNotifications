...
namespace NetPrints.Core
{
    public static class NetPrintsUtil
    {
        ...
        /// <returns></returns>
        public static bool IsVisible(ITypeSpecifier fromType, ITypeSpecifier type, MemberVisibility visibility, Func<ITypeSpecifier, ITypeSpecifier, bool> isSubclassOf)
        {
            // TODO: Internal
