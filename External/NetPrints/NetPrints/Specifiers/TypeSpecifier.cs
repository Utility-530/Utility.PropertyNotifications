...
namespace NetPrints.Core
{
    ...
    [DataContract]
    [Serializable]
    public class TypeSpecifier : BaseType, ITypeSpecifier
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public IObservableCollection<IBaseType> GenericArguments
        {
            get;
            private set;
        }
        ...
        public TypeSpecifier(string typeName, bool isEnum = false, bool isInterface = false, IEnumerable<IBaseType> genericArguments = null)
            : base(typeName)
        {
            IsEnum = isEnum;
            ...
            {
                GenericArguments = new ObservableRangeCollection<IBaseType>();
            }
            else
            {
                GenericArguments = new ObservableRangeCollection<IBaseType>(genericArguments);
            }
        }
        ...
        public static explicit operator TypeSpecifier(Type type)
        {
        ...
        /// <param name="type">Type to create a TypeSpecifier for.</param>
        /// <returns>TypeSpecifier for the given type.</returns>
        public static Type ToType(ITypeSpecifier type)
        {
        ...
        public TypeSpecifier Construct(IReadOnlyDictionary<GenericType, BaseType> typeSpecifiers)
        {
            ...
            var newGenericArgs = new List<IBaseType>(GenericArguments);
