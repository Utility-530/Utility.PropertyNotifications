...
{ 
    ...
    public class Project : IProject
    {
        ...
        /// </summary>
        public ObservableRangeCollection<IClassGraph> Classes
        {
            get;
            private set;
        } = [];
        ...
        /// </summary>
        [DataMember]
        public IObservableCollection<ICompilationReference> References
        {
            get;
            set;
        } = new ObservableRangeCollection<ICompilationReference>();
        ...
        public string GetClassStoragePath(IClassGraph cls)
        {
        ...
        {
            // Save all classes
            foreach (IClassGraph cls in Classes)
            {
        ...
        public Project LoadFromPath(string path)
        {
            ...
            if (ProjectSerializer.ReadObject(fileStream) is Project project)
            {
                ...
                // Load classes
                ConcurrentBag<IClassGraph> classes = new ConcurrentBag<IClassGraph>();
        ...
        private void FixReferencePaths()
        {
            ...
            {
                References.RemoveRange(referencesToRemove.Cast<ICompilationReference>());
        ...
        public void SaveClassInProjectDirectory(IClassGraph cls)
        {
        ...
        public IClassGraph CreateNewClass()
        {
        ...
        public IClassGraph AddExistingClass(string path)
        {
            // Check if a class with the same storage name is already loaded
            string fileName = System.IO.Path.GetFileName(path);
            IClassGraph cls = Classes.FirstOrDefault(c => string.Equals(GetClassStoragePath(c), fileName, StringComparison.OrdinalIgnoreCase));
        ...
        {
            Classes = new ObservableRangeCollection<IClassGraph>();
        }
    }
}
