...
namespace NetPrints.Graph
{
    ...
    /// </summary>
    [DataContract]
    public class NodeInputDataPin : NodeDataPin, INodeInputDataPin
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public INodeOutputDataPin IncomingPin
        {
            get => incomingPin;
            set
            {
        ...
        private INodeOutputDataPin incomingPin;
        ...
        public NodeInputDataPin(INode node, string name, IBaseType pinType)
