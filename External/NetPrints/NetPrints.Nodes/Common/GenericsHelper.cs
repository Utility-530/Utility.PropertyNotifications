...
namespace NetPrints.Graph
{
    public static class GenericsHelper
    {
        ...
        public static IBaseType ConstructWithTypePins(IBaseType type, IEnumerable<INodeInputTypePin> inputTypePins)
        {
            ...
            {
                IBaseType replacementType = inputTypePins.SingleOrDefault(t => t.Name == type.Name)?.InferredType;
