...
namespace NetPrints.Graph
{
    ...
    public class MakeArrayNode : Node
    {
        ...
        /// </summary>
        public INodeInputDataPin SizePin
        {
            get => InputDataPins[0];
        }
        ...
        /// </summary>
        public IBaseType ElementType
        {
            get => ElementTypePin.InferredType ?? TypeSpecifier.FromType<object>();
        }

        /// <summary>
        /// Input type pin for the element type of the array to create.
        /// </summary>
        public INodeInputTypePin ElementTypePin
        {
            get => InputTypePins[0];
        }
        ...
        /// </summary>
        public INodeOutputDataPin ArrayPin
        {
        ...
        public MakeArrayNode(INodeGraph graph)
            : base(graph)
        {
        ...
        public bool RemoveElementPin()
        {
            if (InputDataPins.Count > 0)
            {
                ...
                INodeInputDataPin inputDataPin = InputDataPins[InputDataPins.Count - 1];
