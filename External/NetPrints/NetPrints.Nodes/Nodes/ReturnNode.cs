...
namespace NetPrints.Graph
{
    ...
    public class ReturnNode : Node, IReturnNode
    {
        ...
        /// </summary>
        public INodeInputExecPin ReturnPin
        {
            get { return InputExecPins[0]; }
        }

        public ReturnNode(IMethodGraph graph)
            : base(graph)
        {
        ...
        private void ReplicateMainNodeInputTypes()
        {
            ...
            INodeInputDataPin[] mainInputPins = MethodGraph.MainReturnNode.InputDataPins.ToArray();

            var oldConnections = new Dictionary<int, INodeOutputDataPin>();
            ...
            {
                AddInputDataPin(mainInputPin.Name, mainInputPin.PinType);
            }
        ...
        private void UpdateMainNodeInputTypes()
        {
            ...
            {
                InputDataPins[i].PinType = InputTypePins[i].InferredType ?? TypeSpecifier.FromType<object>();
            }
        }
        ...
        public void AddReturnType()
        {
            ...
            AddInputDataPin($"Output{returnIndex}", TypeSpecifier.FromType<object>());
        ...
        public void RemoveReturnType()
        {
            ...
            {
                INodeInputDataPin idpToRemove = InputDataPins.Last();
