...
namespace NetPrints.Graph
{
    ...
    public class LiteralNode : Node
    {
        ...
        /// </summary>
        public INodeOutputDataPin ValuePin
        {
        ...
        /// </summary>
        public INodeInputDataPin InputValuePin
        {
        ...
        public LiteralNode(INodeGraph graph, TypeSpecifier literalType)
            : base(graph)
        {
        ...
        private void UpdatePinTypes()
        {
            ...
            IBaseType constructedType = GenericsHelper.ConstructWithTypePins(LiteralType, InputTypePins);
        ...
        public static LiteralNode WithValue<T>(INodeGraph graph, T val)
        {
        ...
        {
            return $"Literal - {ValuePin.PinType.ShortName}";
        }
    }
}
