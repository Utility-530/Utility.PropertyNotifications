...
namespace NetPrints.Graph
{
    ...
    public abstract partial class VariableNode : Node
    {
        ...
        /// </summary>
        public ITypeSpecifier TargetType { get => Variable.DeclaringType; }
        ...
        /// </summary>
        public INodeInputDataPin IndexPin
        {
        ...
        protected VariableNode(INodeGraph graph, VariableSpecifier variable)
            : base(graph)
        {
            Variable = variable;
