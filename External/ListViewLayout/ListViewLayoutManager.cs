...
namespace Itenso.Windows.Controls.ListViewLayout
{
    ...
    public class ListViewLayoutManager
    {
        ...
        // ----------------------------------------------------------------------
        public ListViewLayoutManager(ItemsControl itemsControl, GridViewColumnCollection columns)
        {
            ...
            this.itemsControl.Loaded += new RoutedEventHandler(ListViewLoaded);
            this.itemsControl.Unloaded += new RoutedEventHandler(ListViewUnloaded);
        } // ListViewLayoutManager

        // ----------------------------------------------------------------------
        public ItemsControl ListView
        {
        ...
        private void InitColumns()
        {
            ...
            foreach (GridViewColumn gridViewColumn in columns)
            {
                ...
                GridViewColumnHeader columnHeader = FindColumnHeader(itemsControl, gridViewColumn);
        ...
        protected virtual void ResizeColumns()
        {
            ...
            {
                actualWidth = itemsControl.ActualWidth;
            }
        ...
        private bool IsFillColumn(GridViewColumn gridViewColumn)
        {
            ...
            if ((itemsControl is not ListView { View: var view } listView) || view is GridView { Columns.Count: 0 })
            {
                return false;
            }
        ...
        private static void OnLayoutManagerEnabledChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (listView != null)
            {
                ...
                if (enabled && listView.View is GridView gridView)
                {
                    new ListViewLayoutManager(listView, gridView.Columns);
                }
            }
