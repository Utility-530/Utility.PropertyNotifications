...
namespace PixelLab.Wpf.Demo
{
    ...
    public class DemoCollection<T> : ReadOnlyObservableCollection<T>
    {
            ...
            : base(activeItems)
        {
            ...
            m_addCommand = new RelayCommand(Add, () => canAddOrInsert);
            m_insertCommand = new RelayCommand(Insert, () => canAddOrInsert);
            m_removeCommand = new RelayCommand(Remove, () => canRemove);
            m_moveCommand = new RelayCommand(Move, () => canMove);
            m_changeCommand = new RelayCommand(Change, () => canChange);
        ...
        private readonly RelayCommand m_addCommand, m_removeCommand, m_moveCommand, m_changeCommand, m_insertCommand, m_resetCommand;
