...
namespace Utility.WPF.Demo.Collections
{
    ...
    class MainViewModel : ViewModel
    {
        ...
        public Collection TaskList { get; private set; }
        public Collection Activity { get; private set; }
        ...
        public MainViewModel()
        {
            ...
            StartStop = new RelayCommand(a=>OnStartStopWork());
            AddOne = new RelayCommand(a => AddTask());
            AddTwenty = new RelayCommand(a => AddRange());
            Clear = new RelayCommand(a => Activity.Clear());
            IsRunning = false;
        }
