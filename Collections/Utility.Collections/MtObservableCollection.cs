...
namespace JulMar.Windows.Collections
{
    ...
    [Obsolete]
    public class MTObservableCollection<T> : Collection, IList<T>, IList, INotifyCollectionChanged, INotifyPropertyChanged
    {
        #region Private Data

        private const string CountString = "Count";
        private const string IndexerName = "Item[]" /*Binding.IndexerName*/;
        ...
        #endregion Internal Thread Management Methods
