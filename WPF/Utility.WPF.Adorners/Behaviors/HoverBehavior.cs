...
namespace Utility.WPF.Adorners
{
    public class AdornerWrapper
    {
        ...
        public double Opacity
        {
            get
            {
                throw new Exception("sd s");
            }

            set
            {
                foreach (var adorner in adorners)
                    adorner.Opacity = value;
            }
        }

        public void BeginAnimation(DependencyProperty opacityProperty, DoubleAnimation fadeOutAnimation)
        {
            foreach (var adorner in adorners)
        ...
        public void DisconnectChild()
        {
            foreach (var adorner in adorners)
            {
                if (adorner is FrameworkElementAdorner feAdorner)
                {
                    feAdorner.DisconnectChildren();
                }
            }
        }
    ...
    public class HoverBehavior : Behavior<FrameworkElement>
    {
        ...
        public static readonly DependencyProperty IsEnabledProperty =
            DependencyProperty.RegisterAttached("IsEnabled", typeof(bool), typeof(HoverBehavior),
        ...
        /// </summary>
        private AdornerWrapper adornerColllection = null;
        ...
        public static readonly DependencyProperty IsAdornerVisibleProperty =
            DependencyProperty.Register("IsAdornerVisible", typeof(bool), typeof(HoverBehavior),
        ...
        public static readonly DependencyProperty AdornerContentProperty =
            DependencyProperty.Register("AdornerContent", typeof(FrameworkElement), typeof(HoverBehavior),
        ...
        public static readonly DependencyProperty HorizontalAdornerPlacementProperty =
            DependencyProperty.Register("HorizontalAdornerPlacement", typeof(AdornerPlacement), typeof(HoverBehavior),
        ...
        public static readonly DependencyProperty VerticalAdornerPlacementProperty =
            DependencyProperty.Register("VerticalAdornerPlacement", typeof(AdornerPlacement), typeof(HoverBehavior),
                new FrameworkPropertyMetadata(AdornerPlacement.Inside));
        ...
        public static readonly DependencyProperty IsMouseOverShowEnabledProperty =
            DependencyProperty.Register("IsMouseOverShowEnabled", typeof(bool), typeof(HoverBehavior),
        ...
        public static readonly DependencyProperty FadeInTimeProperty =
            DependencyProperty.Register("FadeInTime", typeof(double), typeof(HoverBehavior),
                new FrameworkPropertyMetadata(0.25));

        public static readonly DependencyProperty FadeOutTimeProperty =
            DependencyProperty.Register("FadeOutTime", typeof(double), typeof(HoverBehavior),
                new FrameworkPropertyMetadata(1.0));

        public static readonly DependencyProperty CloseAdornerTimeOutProperty =
            DependencyProperty.Register("CloseAdornerTimeOut", typeof(double), typeof(HoverBehavior),
        ...
        public static readonly DependencyProperty AdornedTemplatePartNameProperty =
            DependencyProperty.Register("AdornedTemplatePartName", typeof(string), typeof(HoverBehavior),
        ...
        public void FadeInAdorner()
        {
            ...
            {
                adornerColllection.Opacity = 0.0;
            }
            ...
            adornerColllection.BeginAnimation(UIElement.OpacityProperty, doubleAnimation);
        ...
        public void FadeOutAdorner()
        {
            ...
            adornerColllection.BeginAnimation(UIElement.OpacityProperty, fadeOutAnimation);
        ...
        //    {
        //        this.AdornerContent.DataContext = AssociatedObject.DataContext;
        //    }
        //}
        ...
        {
            HoverBehavior c = (HoverBehavior)target;
            c.ShowAdorner();
        }
        ...
        {
            HoverBehavior c = (HoverBehavior)o;
        ...
        private void ShowAdornerInternal()
        {
            ...
            adornerColllection.Add(adornerLayer);
        ...
        private void HideAdornerInternal()
        {
            ...
            adornerColllection.RemoveFrom(adornerLayer);
            adornerColllection.DisconnectChild();
        ...
        void Initialise()
        {
            ...
            {
                if (AdornerLayer.GetAdornerLayer(AssociatedObject) is { } adornerLayer && adornerLayer?.GetAdorners(AssociatedObject) is { } adorners)
                {
                    adornerColllection = new();
                    foreach (var adorner in adorners)
                    {
