...
public class CallMethodAction : TriggerAction<DependencyObject>
{
    ...
    protected override void Invoke(object parameter)
    {
        ...
        if (methodDescriptor != null)
        {
            ...
            if (parameters.Length == 2 && AssociatedObject != null && parameter != null && parameters[0].ParameterType.IsAssignableFrom(AssociatedObject.GetType()) && parameters[1].ParameterType.IsAssignableFrom(parameter.GetType()))
            {
                methodDescriptor.MethodInfo.Invoke(Target, new object[2] { AssociatedObject, parameter });
            }
            else
            {
