...
namespace Custom.Controls
{
    ...
    public class EditableTextBlock : Control
    {
        ...
        // Using a DependencyProperty as the backing store for _OldText.  This enables animation, styling, binding, etc...
        ...
        static EditableTextBlock()
        {
            ...
            //Control.ForegroundProperty.OverrideMetadata(typeof(EditableTextBlock), new FrameworkPropertyMetadata(Brushes.Black));
        }
            ...
            : base()
        {
            ...
            //this.MouseEnter += EditableTextBlock_MouseEnter;
            //this.MouseLeave += EditableTextBlock_MouseLeave;
        ...
        //private void EditableTextBlock_MouseLeave(object sender, MouseEventArgs e)
        //{
        ...
        //private void EditableTextBlock_MouseEnter(object sender, MouseEventArgs e)
        //{
        //    if (this.Content is TextBlock textBlock)
        //    {
        ...
        {
            if (this.Content is TextBox textbox)
            {
                textbox.KeyDown -= new KeyEventHandler(OnTextBoxKeyDown);
                textbox.LostFocus -= new RoutedEventHandler(OnTextBoxLostFocus);
                textbox.GotFocus -= new RoutedEventHandler(OnTextBoxGotFocus);
