...
public partial class Store : IResolver, IRegister, IDisposable
{
    ...
    /// <inheritdoc />
    public bool Has(Type? serviceType, string? contract = null)
    {
    ...
    /// <inheritdoc />
    public object? Resolve(Type? serviceType, string? contract = null)
    {
        if (_registry is null)
        {
            return default;
    ...
    /// <inheritdoc />
    //public IDisposable Callback(Type serviceType, string? contract, Action<IDisposable> callback)
    //{
