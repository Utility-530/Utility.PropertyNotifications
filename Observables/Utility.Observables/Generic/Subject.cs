...
namespace Utility.Observables.Generic
{
    ...
    public class Subject<TInput, TOutput> : Subject, Interfaces.Reactive.Generic.IObserver<TInput>, Interfaces.Reactive.Generic.IObservable<TOutput>
    {
        private Func<TInput, TOutput> onNext;

        protected ObservableCollection<Interfaces.Reactive.Generic.IObserver<TOutput>> _observers = new();
        ...
        IEnumerable<Interfaces.Reactive.Generic.IObserver<TOutput>> Interfaces.Reactive.Generic.IObservable<TOutput>.Observers => _observers;
