...
namespace Utility.Nodes.Demo
{
    ...
    internal class CustomFilter : ITreeViewFilter
    {
        public bool Filter(object item)
        {
            ...
            if (item is IReadOnlyTree { Data: BasePropertyObject { Descriptor: { ComponentType: { } componentType, DisplayName: { } displayName } descriptor } propertyNode })
            {
    ...
    public class CustomItemsPanelConverter : ItemsPanelConverter
    {
        ...
        {
            if (value is IReadOnlyTree { Data: BasePropertyObject { Descriptor: { PropertyType:{ }propertyType, ComponentType: { } componentType, DisplayName: { } displayName } descriptor } baseObject })
            {
