...
//                {
//                    c_node
//                    .Descendant(a => (a.Item1 as INodeViewModel).Data.ToString() == NodeMethodFactory.content_root)
//                    .Subscribe(a =>
//                    {
...
//                        transformersModel.Children.SelfAndAdditions<TransformerModel>().Subscribe(transformer =>
//                        {
//                            changes(transformer)
//                            .Subscribe(a =>
//                            {
...
//                                                var dict = transformer.Inputs.Children.ToDictionary(a => a, a => new ArrayList());
...
//                                                .ForEach(a =>
//                                                {
//                                                    foreach tModel input in transformer.Inputs.Children)
//                                                    {
...
//                                                            else
//                                                            {
//                                                                foreach (ResolvableModel target in transformer.Output.Element.Children)
//                                                                {
...
//                .Subscribe(a =>
//                {
//                    a.Value?.Children.Changes().Subscribe(change =>
//                    {
...
//                    .Subscribe(a =>
//                    {
//                        a.Value?.Children.Changes().Subscribe(a =>
//                        {
//                            (a.Value as ResolvableModel).Types.Changes().Subscribe(a => observer.OnNext(Unit.Default));
//                            (a.Value as ResolvableModel).Properties.Changes().Subscribe(a => observer.OnNext(Unit.Default));
//                        }).DisposeWith(composite);
