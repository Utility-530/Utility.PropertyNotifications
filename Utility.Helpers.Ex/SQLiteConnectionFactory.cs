...
//        public static SQLiteConnection Create<T>(string path = null, Func<Type, bool> typePredicate = null)
//        {
...
//                throw new System.Exception($"Unable to retrieve name of directory from {nameof(path)}");
