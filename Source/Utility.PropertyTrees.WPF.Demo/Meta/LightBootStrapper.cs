...
namespace Utility.PropertyTrees.WPF.Demo
{
    public class LightBootStrapper : BaseObject
    {
        ...
        public Container Build()
        {
            ...
            container.Register<Utility.Graph.Shapes.GraphController>(Reuse.Singleton);
        ...
        {
            new Outputs(new Key<AutoObject>(), new IConnection[] { new Connection<PropertyStore>(container) {}, new Connection<PropertyController>(container) { } }),
            new Outputs(new Key<LightBootStrapper>(), new IConnection[] { new Connection<PropertyActivator>(container) }),
            new Outputs(new Key<History>(), new IConnection[] { new Connection<HistoryViewModel>(container) { IsPriority = true, SkipContext =false },  new Connection<Playback>(container) { IsPriority = true, SkipContext =false } }),
            new Outputs(new Key<HistoryViewModel>(), new IConnection[] { new Connection<Playback>(container) { IsPriority = true,  SkipContext =false } }),
            new Outputs(new Key<Playback>(), new IConnection[] { new Connection<History>(container) { IsPriority = true } }),
            new Outputs(new Key<PropertyActivator>(), new IConnection[] {
                new Connection<InterfaceController>(container) { SkipContext = false },
                new Connection<LightBootStrapper>(container) { },
                new Connection<PropertyFilter>(container){ },
                new Connection<ViewModelEngine>(container),
                new Connection<PropertyStore>(container),
                new Connection<ViewBuilder>(container),
                new Connection<MainViewModel>(container),
            }),
            new Outputs(new Key<InterfaceController>(), new IConnection[] {  new Connection<PropertyActivator>(container){  } }),
            new Outputs(new Key<PropertyFilter>(), new IConnection[] { new Connection<PropertyNode>(container) { SkipContext = false }, new Connection<PropertyActivator>(container) { } }),
            new Outputs(new Key<PropertyNode>(), new IConnection[] { new Connection<PropertyFilter>(container) { IsPriority= true /*false*/ } }),
            new Outputs(new Key<Utility.Infrastructure.Resolver>(), new IConnection[]{ new Connection<Utility.Graph.Shapes.GraphController>(container){ IsPriority = true, SkipContext = false } }),
            new Outputs(new Key<ViewModelEngine>(), new IConnection[]{ new Connection<PropertyActivator>(container){ IsPriority = true, SkipContext = false } }),
            new Outputs(new Key<PropertyStore>(), new IConnection[]{ new Connection<PropertyActivator>(container){ IsPriority = true, SkipContext = false }, new Connection<PropertyNode>(container){ IsPriority = true, SkipContext = false } }),
            new Outputs(new Key<MainViewModel>(), new IConnection[]{
                new Connection<ViewBuilder>(container){ IsPriority = true, SkipContext = false },
                new Connection<UdpServerController>(container){ IsPriority = true, SkipContext = false } ,
                new Connection<PropertyActivator>(container){ IsPriority = true, SkipContext = false }
            }),
            new Outputs(new Key < ViewBuilder > (),
                new IConnection[]{
                new Connection<MainViewModel>(container){ IsPriority = true, SkipContext = false },
                new Connection<PropertyActivator>(container){ IsPriority = true, SkipContext = false },
            }),
            new Outputs(new Key<UdpServerController>(), new IConnection[] { new Connection<MainViewModel>(container) { IsPriority= true /*false*/ } }),
