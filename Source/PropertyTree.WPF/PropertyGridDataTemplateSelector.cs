using Abstractions;
using PropertyTrees.WPF.Infrastructure;
using System;
...
namespace PropertyTrees.WPF
{
    ...
    public class PropertyGridDataTemplateSelector : DataTemplateSelector
    {
        ...
        public PropertyTree PropertyTrees
        {
            get
            {
        ...
        public override DataTemplate SelectTemplate(object item, DependencyObject container)
        {
            ...
            {
                _propertyGrid = container.GetVisualSelfOrParent<PropertyTree>();
            }
