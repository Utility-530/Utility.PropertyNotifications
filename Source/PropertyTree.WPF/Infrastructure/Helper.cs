...
namespace PropertyTrees.WPF.Infrastructure
{
    public static class Helper
    {
        ...
        //{
        //    PropertyTrees grid = (PropertyTrees)source;
        ...
        public static void OnEditorSelectorSelectionChanged(PropertyTree parentGrid, string childPropertyGridName, object sender, SelectionChangedEventArgs e)
        {
            ...
            if (sender is FrameworkElement element && e.AddedItems.Count > 0)
            {
                ...
                {
                    if (LogicalTreeHelper.FindLogicalNode(window, childPropertyGridName) is PropertyTree pg)
                    {
                        if (parentGrid != null)
                        {
        ...
        {
            foreach (PropertyTree grid in editor.GetChildren<PropertyTree>())
            {
        ...
        public static async void SelectedObjectPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (d is PropertyTree propertyGrid)
            {
        ...
        //public static IPropertyGridEngine? SelectedObjectPropertyChanged(PropertyTrees grid, DependencyPropertyChangedEventArgs e)
        //{
        ...
        //    {
        //        if (sender is PropertyTrees dispatcherObject)
        //        {
        ...
        //    }
        ////}
        //public static void SetGroupByCategory(PropertyTrees grid, bool value)
        //{
        //    switch (value)
        //    {
        ...
        //public static void UpdateBindings(PropertyTrees grid, object dataItem, string childName, Func<Binding, bool> where, Action<BindingExpression> action)
        //{
        //    if (dataItem == null)
        //    {
