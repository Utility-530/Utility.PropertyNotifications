...
namespace Views.Trees
{
    ...
    {
        public IDisposable Build(ItemsControl treeView, IChildren rootViewModel, ITreeViewItemFactory factory, IValueConverter ItemsPanelConverter, StyleSelector styleSelector, DataTemplateSelector dataTemplateSelector, IFilter filter)
        {
