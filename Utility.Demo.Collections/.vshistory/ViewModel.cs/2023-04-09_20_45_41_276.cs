...
namespace Utility.WPF.Demo.Collections
{
    ...
    class MainViewModel : ViewModel
    {
        ...
        public Models.Collection TaskList { get; private set; }
        public Models.Collection Activity { get; private set; }
        ...
        public MainViewModel()
        {
            ...
            TaskList = new Models.Collection();
            Activity = new Models.Collection();
